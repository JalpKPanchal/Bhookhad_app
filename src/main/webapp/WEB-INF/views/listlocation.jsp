...
<body>
    ...
    <a href="deleteLocation?id=${location.locationId}" onclick="return confirm('Are you sure you want to delete this location?');" style="color: red; text-decoration: none;">Delete</a>
</td>
